...
export default new Vuex.Store({
  state: {
    ...
    optionsDiv: { circle: { [CIRCLE_NORMAL]: [2, 3, 4, 5, 6, 7, 8, 9], [CIRCLE_GRAD]: [2, 3, 4, 5, 6, 7, 8, 9] }, cross: { [CROSS_NORMAL]: [2, 3, 4, 5, 6, 7, 8, 9], [CROSS_GRAD]: [2, 3, 4, 5, 6, 7, 8, 9] }, square: { [SQUARE_NORMAL]: [2, 3, 4, 5, 6, 7, 8, 9], [SQUARE_GRAD]: [2, 3, 4, 5, 6, 7, 8, 9] }, lines: { [LINES_H]: [2, 3, 4, 5, 6, 7, 8, 9], [LINES_H_GRAD]: [2, 3, 4, 5, 6, 7, 8, 9], [LINES_V]: [2, 3, 4, 5, 6, 7, 8, 9], [LINES_V_GRAD]: [2, 3, 4, 5, 6, 7, 8, 9] }, triangle: ["tr"], star: ["st"] }
  },
  getters: {
    // optionsShape(state) {
