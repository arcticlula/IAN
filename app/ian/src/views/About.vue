      ...
      <b-tabs content-class="mt-3" style="font-size: 14px;">
        ...
        <b-tab title="Settings" color="info">
          ...
          <b-row>
            ...
            <b-row class="mb-2">
              <b-col cols="6">
                <b-button @click="sendCustomOr(0)" size="sm" class="mr-1" variant="info">
                  <b-icon icon="arrowsAngleExpand"></b-icon>
                </b-button>
                <b-button @click="sendCustomOr(1)" size="sm" class="mr-1" variant="info">
                  <b-icon icon="arrowsAngleContract"></b-icon>
                </b-button>
              </b-col>
              <b-col cols="6">
                <b-button @click="sendCustomDIV(-1)" size="sm" class="mr-1" variant="info">-</b-button>
                {{maxDiv}}
                <b-button @click="sendCustomDIV(1)" size="sm" class="mr-1" variant="info">+</b-button>
              </b-col>
            </b-row>
